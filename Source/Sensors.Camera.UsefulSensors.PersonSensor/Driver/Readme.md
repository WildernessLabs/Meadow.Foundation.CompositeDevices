...
The **UsefulSensorsPersonSensor** library is included in the **Meadow.Foundation.Sensors.Camera.UsefulSensors.PersonSensor** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
